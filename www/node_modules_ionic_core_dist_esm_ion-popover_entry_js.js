...
/* harmony import */ var _overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./overlays-9c75ec54.js */ 7357);
/* harmony import */ var _framework_delegate_63d1a679_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./framework-delegate-63d1a679.js */ 5132);
...
/* harmony import */ var _index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-9b0d46f4.js */ 8974);
...
/* harmony import */ var _index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-3ad7f18b.js */ 171);
...
const configureDismissInteraction = (triggerEl, triggerAction, popoverEl, parentPopoverEl) => {
  ...
  const root = (0,_helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_4__.g)(parentPopoverEl);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const focusItem = item => {
  const root = (0,_helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_4__.g)(item);
  const button = root.querySelector('button');
  if (button) {
    (0,_helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => button.focus());
  }
};
/**
...
const configureKeyboardInteraction = popoverEl => {
  const callback = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
      var _a;
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidPresent", 7);
    this.willPresent = (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillPresent", 7);
    this.willDismiss = (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillDismiss", 7);
    this.didDismiss = (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidDismiss", 7);
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_2__.B);
    };
    ...
    this.configureTriggerInteraction = () => {
      ...
      if (!triggerEl) {
        (0,_index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_6__.p)(`A trigger element with the ID "${trigger}" was not found in the DOM. The trigger element must be in the DOM when the "trigger" property is set on ion-popover.`, this.el);
        return;
      }
  ...
  connectedCallback() {
    ...
    (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_2__.j)(el);
    configureTriggerInteraction();
  }
  ...
  componentWillLoad() {
    ...
    const popoverId = (_b = (_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_2__.k)(el);
    this.parentPopover = el.closest(`ion-popover:not(#${popoverId})`);
    if (this.alignment === undefined) {
      this.alignment = (0,_ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_7__.b)(this) === 'ios' ? 'center' : 'start';
    }
  }
  componentDidLoad() {
    const {
    ...
    if (parentPopover) {
      (0,_helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_4__.a)(parentPopover, 'ionPopoverWillDismiss', () => {
  ...
  present(event) {
    ...
    return (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_63d1a679_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, el, _this2.component, ['popover-viewport'], _this2.componentProps, inline);
      ...
      if ((0,_helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_4__.k)(el)) {
        yield (0,_index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_9__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_3ad7f18b_js__WEBPACK_IMPORTED_MODULE_9__.w)();
      }
      yield (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_2__.f)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_2__.n)(el);
      }
      unlock();
    })();
  }
  ...
  dismiss(data, role, dismissParentPopover = true) {
    ...
    return (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const shouldDismiss = yield (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_2__.g)(_this3, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this3.event);
      if (shouldDismiss) {
        if (destroyKeyboardInteraction) {
          destroyKeyboardInteraction();
        ...
        yield (0,_framework_delegate_63d1a679_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this3.usersElement);
      }
      unlock();
   ...
   */
  onDidDismiss() {
    return (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    ...
    const desktop = (0,_ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_7__.a)('desktop');
    ...
    return (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.f, Object.assign({
      ...
      class: Object.assign(Object.assign({}, (0,_theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_8__.g)(this.cssClass)), {
        ...
        [_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_2__.F]: focusTrap === false,
    ...
    }), !parentPopover && (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-backdrop", {
    ...
    }, enableArrow && (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
