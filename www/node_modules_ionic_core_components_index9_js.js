"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_ionic_core_components_index9_js"],{
...
const startTapClick = config => {
  ...
  const setActivatedElement = (el, ev) => {
    ...
    const {
      x,
      y
    } = (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.p)(ev);
    // deactivate selected
    if (activatableEle) {
  ...
  _index5_js__WEBPACK_IMPORTED_MODULE_0__.d.addEventListener('pointerdown', pointerDown, true);
  _index5_js__WEBPACK_IMPORTED_MODULE_0__.d.addEventListener('pointerup', pointerUp, true);
  /**
...
//# sourceMappingURL=node_modules_ionic_core_components_index9_js.js.map