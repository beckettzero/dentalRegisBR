...
/* harmony import */ var _overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./overlays-9c75ec54.js */ 7357);
/* harmony import */ var _theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./theme-01f3f29c.js */ 1882);
/* harmony import */ var _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ionic-global-c81d82ab.js */ 9710);
...
/* harmony import */ var _hardware_back_button_06ef3c3e_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./hardware-back-button-06ef3c3e.js */ 5969);
/* harmony import */ var _framework_delegate_63d1a679_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./framework-delegate-63d1a679.js */ 5132);
...
function warnIfAnchorIsHidden(positionAnchor, toast) {
  if (positionAnchor.offsetParent === null) {
    (0,_index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_5__.p)('The positionAnchor element for ion-toast was found in the DOM, but appears to be hidden. This may lead to unexpected positioning of the toast.', toast);
  }
}
/**
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const root = (0,_helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.g)(baseEl);
...
const createSwipeToDismissGesture = (el, toastPosition, onDismiss) => {
   ...
   */
  const wrapperEl = (0,_helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_3__.g)(el).querySelector('.toast-wrapper');
  ...
  const gesture = (0,_index_39782642_js__WEBPACK_IMPORTED_MODULE_11__.createGesture)({
    ...
    gesturePriority: _overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.O,
    /**
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidPresent", 7);
    this.willPresent = (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillPresent", 7);
    this.willDismiss = (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillDismiss", 7);
    this.didDismiss = (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidDismiss", 7);
    ...
    this.delegateController = (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.d)(this);
    this.lockController = (0,_lock_controller_316928be_js__WEBPACK_IMPORTED_MODULE_4__.c)();
    this.triggerController = (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.e)();
    ...
    this.dispatchCancelHandler = ev => {
      ...
      if ((0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.i)(role)) {
    ...
    this.createSwipeGesture = toastPosition => {
      const gesture = this.gesture = createSwipeToDismissGesture(this.el, toastPosition, () => {
         ...
         */
        this.dismiss(undefined, _overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.G);
      });
      gesture.enable(true);
    };
    /**
    ...
    this.duration = _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_8__.c.getNumber('toastDuration', 0);
  ...
  connectedCallback() {
    (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.j)(this.el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    ...
    if (!((_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id)) {
      (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.k)(this.el);
    }
  }
  componentDidLoad() {
    /**
  ...
  present() {
    ...
    return (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const animationPosition = getAnimationPosition(position, anchor, (0,_ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_8__.b)(_this), el);
      /**
      ...
      yield (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.f)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, {
        position,
  ...
  dismiss(data, role) {
    ...
    return (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.g)(_this2, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation,
      /**
   ...
   */
  onDidDismiss() {
    return (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.h)(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  getAnchorElement() {
    ...
    if (position === 'middle' && positionAnchor !== undefined) {
      (0,_index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_5__.p)('The positionAnchor property is ignored when using position="middle".', this.el);
      return undefined;
    }
    if (typeof positionAnchor === 'string') {
      ...
      if (foundEl === null) {
        (0,_index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_5__.p)(`An anchor element with an ID of "${positionAnchor}" was not found in the DOM.`, el);
        return undefined;
      }
      return foundEl;
    }
    ...
    (0,_index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_5__.p)('Invalid positionAnchor value:', positionAnchor, el);
    return undefined;
  }
  buttonClick(button) {
    var _this3 = this;
  ...
  callButtonHandler(button) {
    return (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        try {
          const rtn = yield (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.s)(button.handler);
          if (rtn === false) {
  ...
  renderButtons(buttons, side) {
    ...
    }, buttons.map(b => (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, b.htmlAttributes, {
      type: "button",
      class: buttonClass(b),
      tabIndex: 0,
    ...
    }), b.text), mode === 'md' && (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
  ...
  render() {
    ...
    if (layout === 'stacked' && startButtons.length > 0 && endButtons.length > 0) {
      (0,_index_9b0d46f4_js__WEBPACK_IMPORTED_MODULE_5__.p)('This toast is using start and end buttons with the stacked toast layout. We recommend following the best practice of using either start or end buttons with the stacked toast layout.', el);
    }
    return (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.f, Object.assign({
      key: '68c336f80af04ba484ca9899bae8f40c0d9b7691',
      tabindex: "-1"
    }, this.htmlAttributes, {
      style: {
      ...
      key: '3483b188f14b700964a123997a60a43a2023a1b6',
      class: wrapperClass
    }, (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '1b88544a9b87253b364cbec6285625388979b560',
      class: "toast-container",
      part: "container"
    }, this.renderButtons(startButtons, 'start'), this.icon !== undefined && (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      key: 'bd1c42e3b14af66b880dfe283e3ae910075c0f70',
      class: "toast-icon",
      part: "icon",
      icon: this.icon,
      lazy: false,
      ...
      key: 'a5ef6cdabc1f7c70d11a5f2a0abf8737fe7550e8',
      class: "toast-content",
      role: "status",
      "aria-atomic": "true",
      "aria-live": "polite"
...
const buttonPart = button => {
  return (0,_overlays_9c75ec54_js__WEBPACK_IMPORTED_MODULE_6__.i)(button.role) ? 'button cancel' : 'button';
};
Toast.style = {
