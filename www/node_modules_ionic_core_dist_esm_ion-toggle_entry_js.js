...
/* harmony import */ var _haptic_ac164e4c_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./haptic-ac164e4c.js */ 7099);
/* harmony import */ var _dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dir-babeabeb.js */ 7280);
...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.didLoad = false;
    this.setupGesture = /*#__PURE__*/(0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        toggleTrack
      } = _this;
      if (toggleTrack) {
    ...
    this.getSwitchLabelIcon = (mode, checked) => {
      if (mode === 'md') {
        return checked ? _index_e2cf2ceb_js__WEBPACK_IMPORTED_MODULE_6__.f : _index_e2cf2ceb_js__WEBPACK_IMPORTED_MODULE_6__.r;
      }
      return checked ? _index_e2cf2ceb_js__WEBPACK_IMPORTED_MODULE_6__.r : _index_e2cf2ceb_js__WEBPACK_IMPORTED_MODULE_6__.g;
    };
    ...
    this.disabled = false;
    this.value = 'on';
    this.enableOnOffLabels = _ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_7__.c.get('toggleOnOffLabels');
  ...
  onMove(detail) {
    if (shouldToggle((0,_dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el), this.checked, detail.deltaX, -10)) {
      this.toggleChecked();
      (0,_haptic_ac164e4c_js__WEBPACK_IMPORTED_MODULE_3__.c)();
    }
  }
  onEnd(ev) {
    this.activated = false;
  ...
  renderToggleControl() {
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  render() {
    ...
    const rtl = (0,_dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_4__.i)(el) ? 'rtl' : 'ltr';
    ...
    return (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.f, {
      key: 'b0d648e071bc8095998b519ce4dcdd0ea91575c0',
      onClick: this.onClick,
      class: (0,_theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_5__.c)(color, {
        [mode]: true,
        'in-item': (0,_theme_01f3f29c_js__WEBPACK_IMPORTED_MODULE_5__.h)('ion-item', el),
      ...
      key: '9a2fe1d16dba66a9dfef450efebf2e5cbe3dcd00',
    ...
    }, this.inheritedAttributes)), (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '0ec99e452164d7059cc4f93d09e5b918f82c022a',
      class: {
      ...
      key: '1c5cbc99905a79e842e9487eb3ca654e1bab3c66'
    })), (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'ca8196423b429899febd11c7337d768ff05df6f4',
