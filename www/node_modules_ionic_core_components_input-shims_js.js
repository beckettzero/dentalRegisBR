"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_ionic_core_components_input-shims_js"],{
...
/* harmony import */ var _index5_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index5.js */ 5549);
/* harmony import */ var _index8_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index8.js */ 8346);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers.js */ 5885);
/* harmony import */ var _keyboard_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./keyboard.js */ 2547);
...
const enableHideCaretOnScroll = (componentEl, inputEl, scrollEl) => {
  ...
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.a)(scrollEl, 'ionScrollStart', hideCaret);
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.a)(scrollEl, 'ionScrollEnd', showCaret);
  inputEl.addEventListener('blur', onBlur);
  return () => {
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.b)(scrollEl, 'ionScrollStart', hideCaret);
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.b)(scrollEl, 'ionScrollEnd', showCaret);
...
const enableInputBlurring = () => {
  ...
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.a)(doc, 'ionScrollStart', onScroll);
  doc.addEventListener('focusin', onFocusin, true);
  doc.addEventListener('touchend', onTouchend, false);
  return () => {
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.b)(doc, 'ionScrollStart', onScroll, true);
...
const enableScrollAssist = (componentEl, inputEl, contentEl, footerEl, keyboardHeight, enableScrollPadding, keyboardResize, disableClonedInput = false) => {
   ...
   */
  const addScrollPadding = enableScrollPadding && (keyboardResize === undefined || keyboardResize.mode === _keyboard_js__WEBPACK_IMPORTED_MODULE_2__.a.None);
  /**
   ...
   */
  const platformHeight = _index5_js__WEBPACK_IMPORTED_MODULE_3__.w !== undefined ? _index5_js__WEBPACK_IMPORTED_MODULE_3__.w.innerHeight : 0;
  /**
  ...
  const focusOut = () => {
    ...
    _index5_js__WEBPACK_IMPORTED_MODULE_3__.w === null || _index5_js__WEBPACK_IMPORTED_MODULE_3__.w === void 0 ? void 0 : _index5_js__WEBPACK_IMPORTED_MODULE_3__.w.removeEventListener('ionKeyboardDidShow', keyboardShow);
  ...
  const focusIn = /*#__PURE__*/function () {
    var _ref = (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _index5_js__WEBPACK_IMPORTED_MODULE_3__.w === null || _index5_js__WEBPACK_IMPORTED_MODULE_3__.w === void 0 ? void 0 : _index5_js__WEBPACK_IMPORTED_MODULE_3__.w.addEventListener('ionKeyboardDidShow', keyboardShow);
...
const jsSetFocus = /*#__PURE__*/function () {
  var _ref2 = (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (componentEl, inputEl, contentEl, footerEl, keyboardHeight, enableScrollPadding, disableClonedInput = false, platformHeight = 0, waitForResize = true) {
     ...
     */
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.r)(() => componentEl.click());
    /**
    ...
    if (typeof window !== 'undefined') {
      ...
      const _scrollContent = /*#__PURE__*/function () {
        var _ref3 = (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          ...
          if (contentEl) {
            yield (0,_index8_js__WEBPACK_IMPORTED_MODULE_4__.c)(contentEl, 0, scrollData.scrollAmount, scrollData.scrollDuration);
          }
      ...
      if (contentEl) {
        const scrollEl = yield (0,_index8_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl);
        /**
...
const startInputShims = /*#__PURE__*/function () {
  var _ref4 = (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (config, platform) {
    /**
     * If doc is undefined then we are in an SSR environment
     * where input shims do not apply.
     */
    if (_index5_js__WEBPACK_IMPORTED_MODULE_3__.d === undefined) {
      return;
    }
    ...
    const inputs = Array.from(_index5_js__WEBPACK_IMPORTED_MODULE_3__.d.querySelectorAll('ion-input, ion-textarea'));
     ...
     */
    const keyboardResizeMode = yield _keyboard_js__WEBPACK_IMPORTED_MODULE_2__.K.getResizeMode();
    const registerInput = /*#__PURE__*/function () {
      var _ref5 = (0,C_Users_UserAdminQro_Documents_DentalRegis_dentalRegisIonic_dentalRegisIonic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (componentEl) {
        yield new Promise(resolve => (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.c)(componentEl, resolve));
        const inputRoot = componentEl.shadowRoot || componentEl;
        const inputEl = inputRoot.querySelector('input') || inputRoot.querySelector('textarea');
        const scrollEl = (0,_index8_js__WEBPACK_IMPORTED_MODULE_4__.a)(componentEl);
    ...
    _index5_js__WEBPACK_IMPORTED_MODULE_3__.d.addEventListener('ionInputDidLoad', ev => {
      registerInput(ev.detail);
    });
    _index5_js__WEBPACK_IMPORTED_MODULE_3__.d.addEventListener('ionInputDidUnload', ev => {
...
//# sourceMappingURL=node_modules_ionic_core_components_input-shims_js.js.map