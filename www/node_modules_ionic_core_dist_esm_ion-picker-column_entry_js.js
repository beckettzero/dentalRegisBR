...
const PickerColumn = class {
  constructor(hostRef) {
    ...
    this.initializeScrollListener = () => {
       ...
       */
      const enableHaptics = (0,_ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_5__.a)('ios');
      const {
        el,
        scrollEl
      } = this;
    ...
    this.onKeyDown = ev => {
       ...
       */
      const mobile = (0,_ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_5__.a)('mobile');
      let newOption = null;
      switch (ev.key) {
        case 'ArrowDown':
  ...
  render() {
    ...
    }, this.renderAssistiveFocusable(), (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
