...
const Radio = class {
  ...
  connectedCallback() {
    ...
    if (radioGroup) {
      this.updateState();
      (0,_helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.a)(radioGroup, 'ionValueChange', this.updateState);
    }
  }
  disconnectedCallback() {
    const radioGroup = this.radioGroup;
    if (radioGroup) {
      (0,_helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.b)(radioGroup, 'ionValueChange', this.updateState);
      this.radioGroup = null;
    }
  }
  get hasLabel() {
...
const RadioGroup = class {
  ...
  render() {
    ...
    const mode = (0,_ionic_global_c81d82ab_js__WEBPACK_IMPORTED_MODULE_5__.b)(this);
    (0,_helpers_da915de8_js__WEBPACK_IMPORTED_MODULE_2__.d)(true, el, name, value, false);
    return (0,_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_28849c61_js__WEBPACK_IMPORTED_MODULE_1__.f, {
